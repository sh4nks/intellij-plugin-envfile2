...
**Env File2** is a plugin for JetBrains Intellij IDEA IDE that allows you to set environment variables for your run configurations
from one or multiple files. This is a fork of [ashald/EnvFile](https://github.com/ashald/EnvFile).
