package com.peterjustin.envfile.products.idea.scala;
...
public class SbtEnvFileRunConfiguration extends SbtRunConfiguration {
    ...
    public SettingsEditor<? extends RunConfiguration> getConfigurationEditor() {
        SettingsEditor<SbtRunConfiguration> sbtTasksEditor = new net.ashald.envfile.products.idea.scala.SbtRunEnvFileConfigurationEditor(project(), this);

        SettingsEditorGroup<SbtRunConfiguration> group = new SettingsEditorGroup<>();
        group.addEditor("Configuration", sbtTasksEditor);
        net.ashald.envfile.products.idea.scala.SbtRunConfigurationExtensionManager.getInstance().appendEditors(this, group);
        return group;
    }
}
